/// CoreStabilityFeeTreasury.t.sol
...
import "../../single/CoreStabilityFeeTreasury.sol";
...
contract Usr {
    ...
    function giveFunds(address stabilityFeeTreasury, address lad, uint rad) external {
        CoreStabilityFeeTreasury(stabilityFeeTreasury).giveFunds(lad, rad);
    }
    function takeFunds(address stabilityFeeTreasury, address lad, uint rad) external {
        CoreStabilityFeeTreasury(stabilityFeeTreasury).takeFunds(lad, rad);
    }
    function pullFunds(address stabilityFeeTreasury, address gal, address tkn, uint wad) external {
        return CoreStabilityFeeTreasury(stabilityFeeTreasury).pullFunds(gal, tkn, wad);
    }
...
contract CoreStabilityFeeTreasuryTest is DSTest {
    Hevm hevm;

    SAFEEngine safeEngine;
    CoreStabilityFeeTreasury stabilityFeeTreasury;
    ...
    function setUp() public {
        ...
        stabilityFeeTreasury = new CoreStabilityFeeTreasury(address(safeEngine), alice, address(systemCoinA));
