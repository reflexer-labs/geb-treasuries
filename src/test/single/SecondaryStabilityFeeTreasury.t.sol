/// SecondaryStabilityFeeTreasury.t.sol
...
import "../../single/SecondaryStabilityFeeTreasury.sol";
...
contract Usr {
    ...
    function giveFunds(address stabilityFeeTreasury, address lad, uint rad) external {
        SecondaryStabilityFeeTreasury(stabilityFeeTreasury).giveFunds(lad, rad);
    }
    function takeFunds(address stabilityFeeTreasury, address lad, uint rad) external {
        SecondaryStabilityFeeTreasury(stabilityFeeTreasury).takeFunds(lad, rad);
    }
...
contract SecondaryStabilityFeeTreasuryTest is DSTest {
    Hevm hevm;

    SAFEEngine safeEngine;
    SecondaryStabilityFeeTreasury stabilityFeeTreasury;
    ...
    function setUp() public {
        ...
        stabilityFeeTreasury = new SecondaryStabilityFeeTreasury(address(safeEngine), address(systemCoinA));
    ...
    function testFail_give_to_treasury_itself() public {
        stabilityFeeTreasury.giveFunds(address(stabilityFeeTreasury), rad(5 ether));
    }
    function testFail_take_from_treasury_itself() public {
        stabilityFeeTreasury.takeFunds(address(stabilityFeeTreasury), rad(5 ether));
    }
    ...
    function test_join_big_from_erc20_give() public {
        ...
        assertEq(systemCoin.balanceOf(address(stabilityFeeTreasury)), 0);
        assertEq(safeEngine.coinBalance(address(usr)), rad(5 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(196 ether));
    }
    function test_join_little_from_erc20_give() public {
        ...
        assertEq(systemCoin.balanceOf(address(stabilityFeeTreasury)), 0);
        assertEq(safeEngine.coinBalance(address(usr)), rad(5 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(195 ether) + RAY);
    }
    function testFail_more_debt_than_coin_post_settle_give() public {
        safeEngine.createUnbackedDebt(address(stabilityFeeTreasury), address(this), rad(1000 ether));
        assertEq(systemCoin.balanceOf(address(stabilityFeeTreasury)), 0);
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(200 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), rad(1000 ether));
        stabilityFeeTreasury.giveFunds(address(usr), rad(5 ether));
    }
    function test_no_debt_post_settle_give() public {
        safeEngine.createUnbackedDebt(address(stabilityFeeTreasury), address(this), rad(100 ether));
        assertEq(systemCoin.balanceOf(address(stabilityFeeTreasury)), 0);
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(200 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), rad(100 ether));
        stabilityFeeTreasury.giveFunds(address(usr), rad(5 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(95 ether));
    ...
    function test_manually_settle_give() public {
        ...
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(100 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), 0);
        stabilityFeeTreasury.giveFunds(address(usr), rad(5 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(95 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), 0);
    ...
    function test_more_coin_than_debt_post_join_give() public {
        ...
        safeEngine.createUnbackedDebt(address(stabilityFeeTreasury), address(this), rad(90 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(200 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), rad(90 ether));
        stabilityFeeTreasury.giveFunds(address(usr), rad(5 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(205 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), 0);
        assertEq(safeEngine.coinBalance(address(usr)), rad(5 ether));
    }
    function testFail_less_coin_than_debt_post_join_give() public {
        systemCoin.transfer(address(stabilityFeeTreasury), 100 ether);
        assertEq(systemCoin.balanceOf(address(stabilityFeeTreasury)), 100 ether);
        safeEngine.createUnbackedDebt(address(stabilityFeeTreasury), address(this), rad(101 ether));
        assertEq(safeEngine.coinBalance(address(stabilityFeeTreasury)), rad(100 ether));
        assertEq(safeEngine.debtBalance(address(stabilityFeeTreasury)), rad(101 ether));
        stabilityFeeTreasury.giveFunds(address(usr), rad(5 ether));
    }
}
